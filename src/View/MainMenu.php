    ...
    <div class="container menu__wrapper">
        <div class="row">
            <div class="menu__logo col-4">
                <a href="/">
    <svg class="svg-logo col-4" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
	...
	<path d="M411.3,206.8c-14.4,14.4-29.2,29.3-44.1,44.2c-31.7-61-63.5-122.4-95.2-183.5C318.4,114,365,160.6,411.3,206.8z"/>
                    ...
                    <img class="menu__logo-title" src="\assets\images\miBadger_text.png" alt="text" height="93" width="213">
</a>
            </div>
...
<g>
	...
	<path d="M411.3,206.8c-14.4,14.4-29.2,29.3-44.1,44.2c-31.7-61-63.5-122.4-95.2-183.5C318.4,114,365,160.6,411.3,206.8z"/>
                    ...
                    <img src="\assets\images\miBadger_text.png" alt="text" height="42" width="42">
</a>
            ...
            <ul class="mobile-menu__ul">
                ...
                <li class="mobile-menu__ul--collapsed">
                    <ul class="mobile-menu__ul">
                        ...
                        <li class="mobile-menu__li"><a class="link link--gray" href="02_messanger.html">Messanger</a></li>
...
<header class="header-home">
    <div class="container background background--right background--header background--mobile" style="background-image: url('assets/img/img_background.png');">
        <div class="row">
